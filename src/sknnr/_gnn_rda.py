...
from .transformers import RDATransformer


class GNNRDARegressor(YFitMixin, TransformedKNeighborsRegressor):
    def __init__(self, n_components=None, **kwargs):
        super().__init__(**kwargs)
        self.n_components = n_components

    def _get_transformer(self) -> TransformerMixin:
        return RDATransformer(self.n_components)

    def _more_tags(self):
        unsupported_1d = "RDA requires 2D y arrays."
