...
class EuclideanKNNRegressor(TransformedKNeighborsRegressor):
    ...
    have been standardized to have unit variance (mean=0, stdev=1) using a
    modified `StandardScaler` that uses N-1 degrees of freedom.
    ...
    transformer_ : StandardScalerWithDOF
        The fitted transformer used to standardize feature data.
    """
